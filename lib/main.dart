    ...
    Exercise(
      ...
      guides: [
        ExerciseGuide(
          title: 'Form Benar',
          imageUrl:
              'https://enarahealth.com/wp-content/uploads/2022/03/PngItem_2810409-e1647565708516.png',
        ),
        ExerciseGuide(
    ...
    Exercise(
      ...
      guides: [
        ExerciseGuide(
          ...
          imageUrl:
              'https://liftmanual.com/wp-content/uploads/2023/04/prisoner-jump-squat.jpg',
        ),
      ],
    ),
    Exercise(
      ...
      guides: [
        ExerciseGuide(
          title: 'Form Benar',
          imageUrl:
              'https://liftmanual.com/wp-content/uploads/2023/04/barbell-glute-bridge.jpg',
        ),
        ExerciseGuide(
    ...
    Exercise(
      ...
      guides: [
        ExerciseGuide(
          title: 'Form Benar',
          imageUrl:
              'https://trainingstation.co.uk/cdn/shop/articles/Lunges-movment_d958998d-2a9f-430e-bdea-06f1e2bcc835_1400x.webp',
        ),
        ExerciseGuide(
          title: 'Kesalahan: Lutut Terlalu Maju',
          imageUrl:
              'https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/blogs/30948/images/oeLzh7B7TOqL4pzqpZJa_Lunge_Mistakes_-_YouTube_1.png',
        ),
      ],
    ),
  ],
